...
VCC-1 is in service with the Italian Army and Navy from 1981.
This file represent the version used by the italian marines: the Battaglione San Marco.

Installation:                  

Unzip to a temp director,than move the entire VCC-1 Btg San Marco folder into the groundobjects folder.
That's it!!
